...
<ResponseField name="gettingStarted" type="string">
...
<ResponseField name="notableDependencies" type="string[]">
...
<Steps>
  ...
  <Step title="Fetch Repository Content">
  ...
  <Step title="Generate AI Explanation">
...
<CardGroup cols={2}>
  <Card title="Workers AI Models" icon="brain" href="https://developers.cloudflare.com/workers-ai/models/">
    Explore other models available in Workers AI
  </Card>
  <Card title="GitHub API" icon="github" href="https://docs.github.com/en/rest">
    Learn more about GitHub's REST API
  </Card>
  <Card title="GitHub Repository" icon="code" href="https://github.com/shrinathsnayak/cloudflare-experiments/tree/main/experiments/github-repo-explainer">
