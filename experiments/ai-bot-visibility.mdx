...
<ResponseField name="crawlers" type="array">
  Array of crawler status objects.
  
  <Expandable title="Crawler Object">
...
<ResponseField name="summary" type="object">
  ...
  <Expandable title="Summary Object">
    ...
    <ResponseField name="notSpecified" type="string[]">
...
<Steps>
  <Step title="Fetch robots.txt and page content">
  ...
  <Step title="Parse robots.txt rules">
  ...
  <Step title="Extract page-level signals">
  ...
  <Step title="Compute per-crawler status">
...
<Steps>
  ...
  <Step title="Test the production endpoint">
    ```bash
...
<CardGroup cols={2}>
  <Card title="robots.txt Specification" icon="robot" href="https://developers.google.com/search/docs/crawling-indexing/robots/intro">
    Learn about robots.txt syntax and best practices
  </Card>
  <Card title="Meta Robots Tag" icon="tag" href="https://developers.google.com/search/docs/crawling-indexing/robots-meta-tag">
    Documentation for meta robots directives
  </Card>
  <Card title="AI Crawl Control" icon="shield" href="https://blog.cloudflare.com/declaring-your-aindependence-block-ai-bots-scrapers-and-crawlers-with-a-single-click">
    Cloudflare's AI crawler blocking feature
  </Card>
  <Card title="GitHub Repository" icon="github" href="https://github.com/shrinathsnayak/cloudflare-experiments/tree/main/experiments/ai-bot-visibility">
...
<CardGroup cols={2}>
  <Card title="More Experiments" icon="flask" href="/introduction">
  ...
  <Card title="Hono Framework" icon="bolt" href="https://hono.dev">
    Explore the Hono web framework
  </Card>
  <Card title="Contribute" icon="code-pull-request" href="https://github.com/shrinathsnayak/cloudflare-experiments">
