...
<Tip>Create short links that redirect to long URLs. Uses D1 as the source of truth with KV as a read-through cache for fast redirects.</Tip>
...
<Steps>
  ...
  <Step title="Create KV namespace">
    ...
    <Tip>For local development, create a preview namespace: `npx wrangler kv namespace create LINKS_CACHE --preview`</Tip>
  </Step>
...
<Card title="POST /shorten" icon="link">
...
<Card title="GET /:code" icon="arrow-right">
...
<ParamField path="code" type="TEXT" required>
...
<ParamField path="DB" type="D1Database">
  D1 database binding (name: `link-shortener-db`)
</ParamField>

<ParamField path="LINKS_CACHE" type="KVNamespace">
...
<Steps>
  ...
  <Step title="Create production resources">
...
View the complete source code on GitHub: [link-shortener](https://github.com/shrinathsnayak/cloudflare-experiments/tree/main/experiments/link-shortener)
