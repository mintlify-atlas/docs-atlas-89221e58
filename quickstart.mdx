...
<Steps>
  ...
  <Step title="Access your deployed worker">
...
<CardGroup cols={2}>
  <Card title="Explore Experiments" icon="flask" href="/experiments">
    Browse all available experiments
  </Card>
  <Card title="Philosophy" icon="book" href="/philosophy">
    Learn the design principles
  </Card>
  <Card title="Contributing" icon="code-pull-request" href="/contributing">
    Add your own experiment
  </Card>
  <Card title="GitHub Repository" icon="github" href="https://github.com/shrinathsnayak/cloudflare-experiments">
    View source code
  </Card>
</CardGroup>
