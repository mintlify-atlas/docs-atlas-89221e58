...
<Steps>
  ...
  <Step title="Add new experiments to the table">
...
<Accordion title="How do I report bugs?">
  Use [Issues](https://github.com/shrinathsnayak/cloudflare-experiments/issues) for bugs or feature requests. Provide as much detail as possible.
</Accordion>
...
- Check out existing experiments in the [repository](https://github.com/shrinathsnayak/cloudflare-experiments/tree/main/experiments)
