...
<Tip>
  The best way to learn is to deploy an experiment, look at the code, and modify it. Start with something simple like [Where Am I](https://github.com/shrinathsnayak/cloudflare-experiments/tree/main/experiments/whereami), then move to more complex experiments like [Link Shortener](https://github.com/shrinathsnayak/cloudflare-experiments/tree/main/experiments/link-shortener).
</Tip>

## Get Involved

<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/shrinathsnayak/cloudflare-experiments">
    Star the repo and explore the code
  </Card>
  <Card title="Contributing" icon="code-pull-request" href="https://github.com/shrinathsnayak/cloudflare-experiments/blob/main/CONTRIBUTING.md">
    Learn how to contribute your own experiments
  </Card>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Deploy your first experiment now
  </Card>
  <Card title="Discussions" icon="comments" href="https://github.com/shrinathsnayak/cloudflare-experiments/discussions">
