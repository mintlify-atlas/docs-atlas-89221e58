...
<CardGroup cols={2}>
  ...
  <Card title="Workers AI" icon="brain">
    **Serverless AI inference** at the edge with built-in models.
    
    Run language models directly from Workers:
  ...
  <Card title="Browser Rendering" icon="browser">
    **Headless browser** automation powered by Puppeteer on the edge.
    
    Capture screenshots and interact with web pages:
  ...
  <Card title="HTMLRewriter" icon="code">
...
<CardGroup cols={2}>
  <Card title="D1 (SQL Database)" icon="database">
  ...
  <Card title="Workers KV" icon="key">
  ...
  <Card title="R2 Storage" icon="folder">
...
<CardGroup cols={2}>
  <Card title="Edge Networking" icon="network-wired">
  ...
  <Card title="Fetch API" icon="arrow-right-arrow-left">
...
<Card title="Cloudflare Developer Documentation" icon="book" href="https://developers.cloudflare.com">
